...
export const mockOpportunities: SalesOpportunity[] = [
  ...
  { id: 'opp-3', salesNo: 'A2025-11-001', clientName: '三一重工', projectName: '挖掘机智能产线', amount: 15200000, stage: '中标', winRate: 100, status: '赢', salesman: '王芳', competitor: '库卡', expectedCloseDate: '2026-02-28', notes: '已签订合同', createdAt: '2025-11-20', updatedAt: '2026-02-28', quotationId: 'proj-003' , reasons: '竞对:价格:主机成本,解决方案;竞对:客户关系' },
  ...
  { id: 'opp-7', salesNo: 'A2025-12-001', clientName: '海康威视', projectName: '摄像头组装测试线', amount: 9600000, stage: '投标', winRate: 50, status: '输', salesman: '张明', competitor: '西门子', expectedCloseDate: '2026-03-01', notes: '丢单(竞对):客户关系 竞争对手与客户有长期合作', createdAt: '2025-12-01', updatedAt: '2026-03-01', quotationId: 'proj-004' , reasons: '竞对:价格:主机成本;竞对:客户关系' },
  ...
  { id: 'opp-10', salesNo: 'A2026-04-002', clientName: '富士康', projectName: '电子组装自动化线', amount: 7800000, stage: '机会', winRate: 40, status: '输', salesman: '王芳', competitor: '西门子', expectedCloseDate: '2026-04-15', notes: '放弃(我方):利润过低 毛利率不足12%', createdAt: '2026-02-01', updatedAt: '2026-04-15' , reasons: '放弃:利润过低' },
  { id: 'opp-11', salesNo: 'A2026-06-002', clientName: '上汽集团', projectName: '动力电池智能产线', amount: 16500000, stage: '投标', winRate: 50, status: '输', salesman: '陈伟', competitor: '西门子', expectedCloseDate: '2026-06-15', notes: '丢单(竞对):价格:产品成本 竞争对手设备报价低30%', createdAt: '2026-04-01', updatedAt: '2026-06-15' , reasons: '竞对:价格:解决方案;竞对:技术方案:痛点发掘;竞对:交货期' },
  ...
  { id: 'opp-13', salesNo: 'A2026-07-001', clientName: '一汽大众', projectName: '焊装线自动化改造', amount: 21000000, stage: '中标', winRate: 100, status: '赢', salesman: '张明', competitor: '西门子、倍福', expectedCloseDate: '2026-07-15', notes: '技术方案胜出', createdAt: '2026-05-01', updatedAt: '2026-07-15', reasons: '竞对:价格:主机成本,解决方案;竞对:客户关系', quotationId: 'proj-006' },
  { id: 'opp-14', salesNo: 'A2026-07-002', clientName: '华为技术', projectName: '数据中心智能温控系统', amount: 28000000, stage: '中标', winRate: 100, status: '赢', salesman: '李华', competitor: '施耐德', expectedCloseDate: '2026-07-20', notes: '品牌优势', createdAt: '2026-04-15', updatedAt: '2026-07-20', reasons: '竞对:技术方案:痛点发掘;竞对:品牌', quotationId: 'proj-007' },
  { id: 'opp-15', salesNo: 'A2026-06-003', clientName: '中国中车', projectName: '转向架智能生产线', amount: 19500000, stage: '中标', winRate: 100, status: '赢', salesman: '王芳', competitor: 'ABB', expectedCloseDate: '2026-06-30', notes: '', createdAt: '2026-03-20', updatedAt: '2026-06-30', reasons: '竞对:价格:主机成本;竞对:技术方案:痛点发掘', quotationId: 'proj-008' },
  { id: 'opp-16', salesNo: 'A2026-07-003', clientName: '万华化学', projectName: '化工仓储自动化升级', amount: 12500000, stage: '中标', winRate: 100, status: '赢', salesman: '陈伟', competitor: '罗克韦尔', expectedCloseDate: '2026-07-10', notes: '', createdAt: '2026-04-01', updatedAt: '2026-07-10', reasons: '竞对:客户关系', quotationId: 'proj-009' },
  // 以下为补充月度销售额数据（FY2526 不同月份的赢单）
  { id: 'opp-17', salesNo: 'A2025-10-001', clientName: '格力电器', projectName: '空调压缩机装配线', amount: 16800000, stage: '中标', winRate: 100, status: '赢', salesman: '李华', competitor: '西门子', expectedCloseDate: '2025-10-30', notes: '', createdAt: '2025-08-15', updatedAt: '2025-10-25', reasons: '竞对:技术方案:痛点发掘', quotationId: 'proj-010' },
  { id: 'opp-18', salesNo: 'A2025-12-002', clientName: '宝钢股份', projectName: '冷轧板智能仓储系统', amount: 22300000, stage: '中标', winRate: 100, status: '赢', salesman: '王芳', competitor: 'ABB', expectedCloseDate: '2025-12-20', notes: '', createdAt: '2025-10-01', updatedAt: '2025-12-15', reasons: '竞对:价格:解决方案', quotationId: 'proj-011' },
  { id: 'opp-19', salesNo: 'A2026-04-001', clientName: '隆基绿能', projectName: '光伏组件自动包装线', amount: 14200000, stage: '中标', winRate: 100, status: '赢', salesman: '张明', competitor: '倍福', expectedCloseDate: '2026-04-25', notes: '', createdAt: '2026-02-01', updatedAt: '2026-04-20', reasons: '竞对:客户关系;竞对:品牌', quotationId: 'proj-012' },
  { id: 'opp-20', salesNo: 'A2026-05-002', clientName: '海尔智家', projectName: '洗碗机总装线升级', amount: 18600000, stage: '中标', winRate: 100, status: '赢', salesman: '陈伟', competitor: '库卡', expectedCloseDate: '2026-05-28', notes: '', createdAt: '2026-03-10', updatedAt: '2026-05-25', reasons: '竞对:价格:主机成本', quotationId: 'proj-013' },
];

// ===== 报价摘要 Mock =====
export const mockQuotationSummaries: QuotationSummary[] = [
  { id: 'proj-001', salesNo: 'A2026-01-001', clientName: '南京埃斯顿智能工业集团股份有限公司', projectName: '双料垛料库 MS3015-13*16-2', versionNo: 'V1.0', status: 'draft', amount: 11800000, totalCost: 9200000, profitRate: 22.0, createdAt: '2026-01-15', updatedAt: '2026-06-22', opportunityId: 'opp-1' },
  { id: 'proj-002', salesNo: 'A2026-01-002', clientName: '徐工集团', projectName: '智能仓储系统升级', versionNo: 'V1.2', status: 'pending', amount: 8500000, totalCost: 6800000, profitRate: 20.0, createdAt: '2026-01-20', updatedAt: '2026-06-20', opportunityId: 'opp-2' },
  { id: 'proj-003', salesNo: 'A2025-11-001', clientName: '三一重工', projectName: '挖掘机智能产线', versionNo: 'V2.0', status: 'approved', amount: 15200000, totalCost: 11800000, profitRate: 22.4, createdAt: '2025-11-15', updatedAt: '2026-02-25', opportunityId: 'opp-3' },
  { id: 'proj-004', salesNo: 'A2025-12-001', clientName: '海康威视', projectName: '摄像头组装测试线', versionNo: 'V1.1', status: 'rejected', amount: 9600000, totalCost: 8200000, profitRate: 14.6, createdAt: '2025-12-10', updatedAt: '2026-02-28', opportunityId: 'opp-7' },
  { id: 'proj-005', salesNo: 'A2026-03-001', clientName: '比亚迪汽车', projectName: '电池 pack 自动化产线', versionNo: 'V1.0', status: 'pending', amount: 22000000, totalCost: 18500000, profitRate: 15.9, createdAt: '2026-03-05', updatedAt: '2026-06-10', opportunityId: 'opp-5' },
  { id: 'proj-006', salesNo: 'A2026-07-001', clientName: '一汽大众', projectName: '焊装线自动化改造', versionNo: 'V1.0', status: 'approved', amount: 21000000, totalCost: 16800000, profitRate: 20.0, createdAt: '2026-06-01', updatedAt: '2026-07-15', opportunityId: 'opp-13' },
  { id: 'proj-007', salesNo: 'A2026-07-002', clientName: '华为技术', projectName: '数据中心智能温控系统', versionNo: 'V1.0', status: 'approved', amount: 28000000, totalCost: 21840000, profitRate: 22.0, createdAt: '2026-06-10', updatedAt: '2026-07-20', opportunityId: 'opp-14' },
  { id: 'proj-008', salesNo: 'A2026-06-003', clientName: '中国中车', projectName: '转向架智能生产线', versionNo: 'V1.0', status: 'approved', amount: 19500000, totalCost: 15600000, profitRate: 20.0, createdAt: '2026-05-01', updatedAt: '2026-06-30', opportunityId: 'opp-15' },
  { id: 'proj-009', salesNo: 'A2026-07-003', clientName: '万华化学', projectName: '化工仓储自动化升级', versionNo: 'V1.0', status: 'approved', amount: 12500000, totalCost: 10000000, profitRate: 20.0, createdAt: '2026-05-15', updatedAt: '2026-07-10', opportunityId: 'opp-16' },
  { id: 'proj-010', salesNo: 'A2025-10-001', clientName: '格力电器', projectName: '空调压缩机装配线', versionNo: 'V1.0', status: 'approved', amount: 16800000, totalCost: 13440000, profitRate: 20.0, createdAt: '2025-09-01', updatedAt: '2025-10-25', opportunityId: 'opp-17' },
  { id: 'proj-011', salesNo: 'A2025-12-002', clientName: '宝钢股份', projectName: '冷轧板智能仓储系统', versionNo: 'V1.0', status: 'approved', amount: 22300000, totalCost: 17840000, profitRate: 20.0, createdAt: '2025-11-01', updatedAt: '2025-12-15', opportunityId: 'opp-18' },
  { id: 'proj-012', salesNo: 'A2026-04-001', clientName: '隆基绿能', projectName: '光伏组件自动包装线', versionNo: 'V1.0', status: 'approved', amount: 14200000, totalCost: 11360000, profitRate: 20.0, createdAt: '2026-03-01', updatedAt: '2026-04-20', opportunityId: 'opp-19' },
  { id: 'proj-013', salesNo: 'A2026-05-002', clientName: '海尔智家', projectName: '洗碗机总装线升级', versionNo: 'V1.0', status: 'approved', amount: 18600000, totalCost: 14880000, profitRate: 20.0, createdAt: '2026-04-01', updatedAt: '2026-05-25', opportunityId: 'opp-20' },
];

// ===== 审批请求 Mock =====
export const mockApprovalRequests: ApprovalRequest[] = [
  // ── 报价审批 ──
  { id: 'apr-1', approvalType: 'quotation', quotationId: 'proj-002', salesNo: 'A2026-01-002', clientName: '徐工集团', projectName: '智能仓储系统升级', amount: 8500000, totalCost: 6800000, profitRate: 20.0, gp3: 0.165, submitter: '李华', submitTime: '2026-06-20', status: 'pending', records: [] },
  { id: 'apr-2', approvalType: 'quotation', quotationId: 'proj-001', salesNo: 'A2026-01-001', clientName: '南京埃斯顿智能工业集团股份有限公司', projectName: '双料垛料库 MS3015-13*16-2', amount: 11800000, totalCost: 9200000, profitRate: 22.0, gp3: 0.185, submitter: '张明', submitTime: '2026-06-18', status: 'approved', records: [{ id: 'rec-1', reviewer: '刘总监', action: 'approved', comment: '毛利率达标，同意', createdAt: '2026-06-19' }] },
  { id: 'apr-3', approvalType: 'quotation', quotationId: 'proj-004', salesNo: 'A2025-12-001', clientName: '海康威视', projectName: '摄像头组装测试线', amount: 9600000, totalCost: 8200000, profitRate: 14.6, gp3: 0.128, submitter: '张明', submitTime: '2026-02-26', status: 'rejected', records: [{ id: 'rec-2', reviewer: '刘总监', action: 'rejected', comment: 'GP3 仅 12.8%，低于 15% 红线，请重新核算成本或调整报价', createdAt: '2026-02-27' }] },
  { id: 'apr-4', approvalType: 'quotation', quotationId: 'proj-005', salesNo: 'A2026-03-001', clientName: '比亚迪汽车', projectName: '电池 pack 自动化产线', amount: 22000000, totalCost: 18500000, profitRate: 15.9, gp3: 0.138, submitter: '陈伟', submitTime: '2026-06-10', status: 'pending', records: [] },
  { id: 'apr-5', approvalType: 'quotation', quotationId: 'proj-003', salesNo: 'A2025-11-001', clientName: '三一重工', projectName: '挖掘机智能产线', amount: 15200000, totalCost: 11800000, profitRate: 22.4, gp3: 0.195, submitter: '王芳', submitTime: '2026-02-20', status: 'approved', records: [{ id: 'rec-3', reviewer: '刘总监', action: 'approved', comment: '方案成熟，报价合理', createdAt: '2026-02-22' }] },
  // ── 交付实施计划审批 ──
  { id: 'apr-plan-1', approvalType: 'plan', quotationId: 'proj-003', deliveryId: 'del-1', salesNo: 'A2026-003', clientName: '三一重工', projectName: '挖掘机智能产线', amount: 15200000, totalCost: 0, profitRate: 0, gp3: 0, submitter: '方案经理', submitTime: '2026-06-25', status: 'pending', records: [] },
  // ── 交付成本对比审批 ──
  { id: 'apr-cost-1', approvalType: 'cost', quotationId: 'proj-001', deliveryId: 'del-2', salesNo: 'A2026-001', clientName: '南京埃斯顿智能工业集团股份有限公司', projectName: '双料垛料库 MS3015-13*16-2', amount: 11800000, totalCost: 9580000, profitRate: 0, gp3: 0, submitter: '交付经理', submitTime: '2026-06-28', status: 'pending', records: [] },
];
